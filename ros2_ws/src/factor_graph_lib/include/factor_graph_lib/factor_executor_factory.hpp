...
public:
    ...
    static std::unique_ptr<FactorExecutor> create(
        ...
        return std::make_unique<FactorExecutorSingleRobot>(debug_mode, initial_load_state, initial_robot_state, final_load_goal, robot_height, last_u, last_tension, tune_d, tune_b);
    }
    ...
    static std::unique_ptr<FactorExecutor> create(
        ...
        const map<string, double>& tune_d,
        const map<string, bool>& tune_b) {
        return std::make_unique<FactorExecutorSingleRobotWithOrientation>(debug_mode, initial_load_state, initial_robot_state, final_load_goal, robot_height, tune_d, tune_b);
    }
    ...
    static std::unique_ptr<FactorExecutor> create(
        ...
        const map<string, double>& tune_d,
        const map<string, bool>& tune_b) {
        return std::make_unique<FactorExecutorTwoRobots>(debug_mode, initial_load_state, initial_robot1_state, initial_robot2_state, final_load_goal, robot_height1, robot_height2, last_u1, last_u2, tune_d, tune_b);
    }
    ...
    static std::unique_ptr<FactorExecutor> create(
        ...
        const map<string, double>& tune_d,
        const map<string, bool>& tune_b) {
        return std::make_unique<FactorExecutorTwoRobotsWithOrientation>(debug_mode, initial_load_state, initial_robot1_state, initial_robot2_state, final_load_goal, robot_height1, robot_height2, tune_d, tune_b);
    }
    ...
    static std::unique_ptr<FactorExecutor> create(
        ...
        return std::make_unique<FactorExecutorMultiRobotsWithOrientation>(debug_mode, robot_num, initial_load_state, initial_robot_states, final_load_goal, robot_heights, tune_d, tune_b);
    }
