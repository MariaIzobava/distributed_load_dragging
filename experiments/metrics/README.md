...
This folder contains a python script which can generate metrics based on the data saved for a particular scenario.
...
```
python3 main.py --num_robots=1 --load_ori --robot_height
```